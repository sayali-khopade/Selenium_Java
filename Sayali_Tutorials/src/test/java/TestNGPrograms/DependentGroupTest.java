...
public class DependentGroupTest {
	public WebDriver driver;
	  ...
	  @Test(dependsOnGroups = "OpenBrowser",groups = "SignIn")
	  ...
	  @Test(dependsOnGroups = "SignIn",groups = "BookSearch")
	  ...
	  @Test(dependsOnGroups = "BookSearch",groups = "SignOut")
	  public void logout() {
